...
#define LF                  6   // Left forward pin - B1IN
#define LR                  5   // Left reverse pin - B2IN
#define RF                  11  // Right forward pin - A1IN
#define RR                  10  // Right reverse pin - A2IN

#define PI                  3.141592654

#define ALEX_LENGTH         10
...
void setupMotors()
{
   ...
   */
   ...
   TCNT1 = 0;
   TCNT2 = 0;
   TCCR0A = 0b10100001; // Set OCOM0A to 10 and WGM to 01
   TCCR1A = 0b00100001;
   TCCR2A = 0b10000001;
